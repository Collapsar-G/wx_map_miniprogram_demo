...
Page({
  ...
  onLoad: function() {
    ...
    var user = wx.getStorageSync('user');
        console.log(user)
        wx.request({
          url: 'http://127.0.0.1:5000/wxuser_navigation_add/' + user.openid + '/' + app.globalData.startaddress + '/' + app.globalData.startLongitude + '/' + app.globalData.startLatitude + '/' + app.globalData.endaddress + '/' + app.globalData.endLongitude + '/' + app.globalData.endLatitude + '/'+ '吕梁' + '/',
